...
public class Item {
    ...
    @XmlElement(name="facltNm")
    private String facltNm;

    @XmlElement(name="lineIntro")
    private String lineIntro;

    @XmlElement(name="intro")
    private String intro;

    @XmlElement(name="allar")
    private String allar;

    @XmlElement(name="insrncAt")
    private String insrncAt;

    @XmlElement(name="trsagntNo")
    private String trsagntNo;

    @XmlElement(name="bizrno")
    private String bizrno;

    @XmlElement(name="facltDivNm")
    private String facltDivNm;

    @XmlElement(name="mangeDivNm")
    private String mangeDivNm;

    @XmlElement(name="mgcDiv")
    private String mgcDiv;

    @XmlElement(name="manageSttus")
    private String manageSttus;

    @XmlElement(name="hvofBgnde")
    private String hvofBgnde;

    @XmlElement(name="hvofEnddle")
    private String hvofEnddle;

    @XmlElement(name="featureNm")
    private String featureNm;

    @XmlElement(name="induty")
    private String induty;

    @XmlElement(name="lctCl")
    private String lctCl;

    @XmlElement(name="doNm")
    private String doNm;
    ...
    @XmlElement(name="resveUrl")
    private String resveUrl;

    @XmlElement(name="resveCl")
    private String resveCl;

    @XmlElement(name="manageNmpr")
    private String manageNmpr;

    @XmlElement(name="gnrlSiteCo")
    private String gnrlSiteCo;

    @XmlElement(name="autoSiteCo")
    private String autoSiteCo;

    @XmlElement(name="glampSiteCo")
    private String glampSiteCo;

    @XmlElement(name="caravSiteCo")
    private String caravSiteCo;

    @XmlElement(name="indvdlCaravSiteCo")
    private String indvdlCaravSiteCo;

    @XmlElement(name="sitedStnc")
    private String sitedStnc;

    @XmlElement(name="siteMg1Width")
    private String siteMg1Width;

    @XmlElement(name="siteMg2Width")
    private String siteMg2Width;

    @XmlElement(name="siteMg3Width")
    private String siteMg3Width;

    @XmlElement(name="siteMg1Vrticl")
    private String siteMg1Vrticl;

    @XmlElement(name="siteMg2Vrticl")
    private String siteMg2Vrticl;

    @XmlElement(name="siteMg3Vrticl")
    private String siteMg3Vrticl;

    @XmlElement(name="siteMg1Co")
    private String siteMg1Co;

    @XmlElement(name="siteMg2Co")
    private String siteMg2Co;

    @XmlElement(name="siteMg3Co")
    private String siteMg3Co;

    @XmlElement(name="siteBottomCl1")
    private String siteBottomCl1;

    @XmlElement(name="siteBottomCl2")
    private String siteBottomCl2;

    @XmlElement(name="siteBottomCl3")
    private String siteBottomCl3;

    @XmlElement(name="siteBottomCl4")
    private String siteBottomCl4;

    @XmlElement(name="siteBottomCl5")
    private String siteBottomCl5;

    @XmlElement(name="tooltip")
    private String tooltip;

    @XmlElement(name="glampInnerFclty")
    private String glampInnerFclty;

    @XmlElement(name="caravInnerFclty")
    private String caravInnerFclty;

    @XmlElement(name="prmisnDe")
    private String prmisnDe;

    @XmlElement(name="operPdCl")
    private String operPdCl;

    @XmlElement(name="operDeCl")
    private String operDeCl;

    @XmlElement(name="trlerAcmpnyAt")
    private String trlerAcmpnyAt;

    @XmlElement(name="caravAcmpnyAt")
    private String caravAcmpnyAt;

    @XmlElement(name="toiletCo")
    private String toiletCo;

    @XmlElement(name="swrmCo")
    private String swrmCo;

    @XmlElement(name="wtrplCo")
    private String wtrplCo;

    @XmlElement(name="brazierCl")
    private String brazierCl;

    @XmlElement(name="sbrsCl")
    private String sbrsCl;

    @XmlElement(name="sbrsEtc")
    private String sbrsEtc;

    @XmlElement(name="posblFcltyCl")
    private String posblFcltyCl;

    @XmlElement(name="posblFcltyEtc")
    private String posblFcltyEtc;

    @XmlElement(name="clturEventAt")
    private String clturEventAt;

    @XmlElement(name="clturEvent")
    private String clturEvent;

    @XmlElement(name="exprnProgrmAt")
    private String exprnProgrmAt;

    @XmlElement(name="exprnProgrm")
    private String exprnProgrm;

    @XmlElement(name="extshrCo")
    private String extshrCo;

    @XmlElement(name="frprvtWrppCo")
    private String frprvtWrppCo;

    @XmlElement(name="frprvtSandCo")
    private String frprvtSandCo;

    @XmlElement(name="fireSensorCo")
    private String fireSensorCo;

    @XmlElement(name="themaEnvrnCl")
    private String themaEnvrnCl;

    @XmlElement(name="eqpmnLendCl")
    private String eqpmnLendCl;

    @XmlElement(name="animalCmgCl")
    private String animalCmgCl;

    @XmlElement(name="tourEraCl")
    private String tourEraCl;

    @XmlElement(name="firstImageUrl")
